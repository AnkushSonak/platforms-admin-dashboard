...
import type { IAnswerKey } from '@/app/helper/interfaces/IAnswerKey';
...
export default function AdminAnswerKeysPage() {
  ...
  const [answerKeys, setAnswerKeys] = useState<IAnswerKey[]>([]);
  ...
  const fetchAnswerKeys = useCallback(async () => {
    ...
    try {
      ...
      const result = await getPaginatedEntity<IAnswerKey>("type=answer-keys&page=1", ANSWER_KEYS_API,  { entityName: "answerKeys" })
                  ...
                  {answerKeys.length === 0 ? (
                    ...
                    <TableRow key={card.id}>
                      ...
                      <TableCell className="flex gap-2">
                        ...
                        <Link href={`/answer-keys/${card.slug}/edit`} passHref>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This action cannot be undone. This will permanently delete the Answer Key posting &quot;{card.title}&quot;.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
